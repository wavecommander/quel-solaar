...
//	seduce_popup_detect_mouse(input, 2, light_organ_popup_func, NULL); /* Middle mouse button (2) activates popup */
//	seduce_popup_detect_multitouch(input, 5, light_organ_popup_func, NULL); /* Putting 5 mult touch points on screen at the same time activates popup */
