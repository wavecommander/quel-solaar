...
boolean	seduce_manipulator_point_axis_internal(BInputState *input, SeduceManipulatorGrab *grab, RMatrix *m, float *pos, void *id, uint part, float *snap, boolean snap_active, uint axis, float scale, float *matrix, uint icon)
{
...
boolean	seduce_manipulator_point_plane_internal(BInputState *input, SeduceManipulatorGrab *grab, RMatrix *m, float *pos, void *id, uint part, float *snap, boolean snap_active, uint axis, float scale, float *matrix, uint icon)
{
	static boolean *a_button = NULL, *a_button_last;
	float tmp[3], f;
	uint i, count, active_pointer = -1, pointer_count, user_count, p;
...
boolean	seduce_manipulator_point_pos_internal(BInputState *input, SeduceManipulatorGrab *grab, RMatrix *m, float *pos, void *id, uint part, float *snap, boolean snap_active, float scale, float *matrix, uint icon)
{
	static boolean *a_button = NULL, *a_button_last;
	float tmp[3], f;
	uint i, count, active_pointer = -1, pointer_count, user_count, p;
