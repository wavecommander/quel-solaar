...
void sui_text_line_edit_draw(BInputState *input, float pos_x, float pos_y, float size, float spacing, float length, char *text, uint *scroll_start, uint select_start, uint select_end, float red, float green, float blue, float alpha)
{
	static uint seed = 0;
...
extern boolean seduce_text_block_length(float *output, float pos_x, float pos_y, float line_size, float height, float line_spacing, SUIBlockStyle style, const char *text, uint pos, STextBlockMode *modes, uint mode_count, uint end);
...
uint seduce_text_block_hit_detect(float pos_x, float pos_y, float line_size, float height, float line_spacing, SUIBlockStyle style, const char *text, uint pos, STextBlockMode *modes, uint mode_count, float pointer_x, float pointer_y);
...
void sui_text_monospace_edit_scroll(char *text, uint line_count, uint line_length, uint *scroll, uint curser)
{
...
void sui_text_edit_up(char *text, uint *select_start, uint *select_end)
{
...
void sui_text_edit_down(char *text, uint *select_start, uint *select_end)
{
...
void sui_text_edit_delete(char *text, uint length, uint *select_start, uint *select_end, STextBlockMode *modes, uint mode_count)
{
	char insert[1] = {0};
...
void sui_text_edit_backspace(char *text, uint length, uint *select_start, uint *select_end, STextBlockMode *modes, uint mode_count)
{
	char insert[1] = {0};
...
void sui_text_edit_insert_character(char *text, uint length, uint *select_start, uint *select_end, uint32 character, STextBlockMode *modes, uint mode_count)
{
	char insert[7];
...
void sui_text_edit_paste(char *text, uint length, uint *select_start, uint *select_end, STextBlockMode *modes, uint mode_count)
{
	uint i;
	char *paste;
	if(*select_start > *select_end)
...
void sui_text_edit_cut(char *text, uint length, uint *select_start, uint *select_end, STextBlockMode *modes, uint mode_count)
{
	char character;
	uint i;
	char *paste;
