...
boolean r_shader_init(void)
{
    ...
    for(i = 0; version[i] != 0 && (version[i] < '0' || version[i] > '9'); i++); /* walk past any non numbers */
    j = i;
