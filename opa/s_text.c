...
uint seduce_text_line_hit_test(float letter_size, float letter_spacing, const char *text, float pos_x)
{
	...
	uint end = -1;
	font = seduce_font_default_get();
	seduce_text_line_length_internal(font, letter_size, letter_spacing, 0, text, &end, pos_x);
	return end;
}
...
uint seduce_text_block_draw(float pos_x, float pos_y, float line_size, float height, float line_spacing, SUIBlockStyle style, const char *text, uint pos, STextBlockMode *modes, uint mode_count)
{
...
void seduce_text_block_select_draw(BInputState *input, float pos_x, float pos_y, float line_size, float height, float line_spacing, SUIBlockStyle style, const char *text, uint pos, STextBlockMode *modes, uint mode_count, uint select_start, uint select_end)
{
...
boolean seduce_text_block_length(float *output, float pos_x, float pos_y, float line_size, float height, float line_spacing, SUIBlockStyle style, const char *text, uint pos, STextBlockMode *modes, uint mode_count, uint end)
{
	uint i, j, next, gaps, start_block = 0, block, line_end, accum;
...
float seduce_text_block_height(float line_size, float line_spacing, SUIBlockStyle style, const char *text, uint pos, STextBlockMode *modes, uint mode_count, uint end)
{
	float output[2];
