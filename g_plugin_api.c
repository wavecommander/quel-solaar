...
/* API needed to be implemented by pulugin */
...
void (*gather_plugin_format_register)(char *name, char *file_extention, boolean load, boolean save, boolean image, boolean audio, boolean video);
...
ILibExport IInterface *imagine_lib_main(IInterface *exe_interface)
{
	...
	gather_plugin_format_register = imagine_library_interface_get_by_name(exe_interface, "gather_plugin_format_register");
