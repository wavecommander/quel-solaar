...
//	float background_color[4] = {0.7, 0.7, 0.7, 0.7}, color[4] = {0.7, 0.7, 0.7, 0.7};
	...
	if(element_count != LA_SETTINGS_COUNT + betray_settings_count())
	{
		...
		comment = "shape of FSAA. Requires restart";
		element[9].type = SEDUCE_PET_COLOR_RGBA;
		element[9].text = seduce_translate("AntiAliasing level"); 
		element[9].param.color[0] = 1;
		element[9].param.color[1] = 1;
		element[9].param.color[2] = 1;
		element[9].param.color[3] = 1;
		element[9].description = comment;	
	}
