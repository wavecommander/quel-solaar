...
extern "C" {
	...
	extern void (*gather_plugin_format_register)(char *name, char *file_extention, boolean load, boolean save, boolean image, boolean audio, boolean video);
...
void gather_plugin_init()
{
	...
	gather_plugin_format_register("Portable Network Graphics", "png", TRUE, FALSE, TRUE, FALSE, FALSE);
	gather_plugin_format_register("Bitmap Image File", "bmp", TRUE, FALSE, TRUE, FALSE, FALSE);
	gather_plugin_format_register("Joint Picture Expert Group", "jpg", TRUE, FALSE, TRUE, FALSE, FALSE);
}
