									...
									float surface_r, float surface_g, float surface_b, float surface_a)
{
	...
	object->triangles[object->surface_used].id = id;
	object->triangles[object->surface_used].part = part;
	object->triangles[object->surface_used].a[0] = a_x;
	object->triangles[object->surface_used].a[1] = a_y;
	object->triangles[object->surface_used].a[2] = a_z;
	object->triangles[object->surface_used].b[0] = b_x;
	object->triangles[object->surface_used].b[1] = b_y;
	object->triangles[object->surface_used].b[2] = b_z;
	object->triangles[object->surface_used].c[0] = c_x;
	object->triangles[object->surface_used].c[1] = c_y;
	object->triangles[object->surface_used].c[2] = c_z;
	object->surface_used++;
}
