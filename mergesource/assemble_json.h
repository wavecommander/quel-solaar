...
extern AJasonArrayCount assemble_json_value_array_first_get_length(AJsonValue *value); /* Returns the number of elements in the ARRAY. */
...
extern AJsonValue	*assemble_json_value_array_add_to_create(AJsonValue *array, AJsonValue *after, AJsonType type, double number, char *string); /* Creates a new value and inserts it to a object value under the name "name". The new value will be of type "type". If the value is of type A_JT_NUMBER, the "number" param will be used to set its value. If the value is of type A_JT_STRING, the "string" param will be used to set its value. The function will return a pointer to the new object.*/
extern void			*assemble_json_value_array_get_allocate(AJsonValue *array, AJsonType output_array_type); /* Allocates an array of A_JT_BOOLEAN, A_JT_STRING, A_JT_NUMBER_FLOAT, A_JT_NUMBER_DOUBLE, A_JT_NUMBER_DECIMAL */
