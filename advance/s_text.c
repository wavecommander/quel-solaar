...
uint sui_text_block_draw_sample(float letter_size, float letter_spacing, float line_size, float line_spacing, uint line_count, const char *text)
{
...
uint sui_text_block_draw(float letter_size, float letter_spacing, float line_size, float line_spacing, uint line_count, const char *text)
{
	if(sui_draw_aa_samples > 1)
	{
		...
		for(i = 0; i < sui_draw_aa_samples; i++)
		{
			...
			glViewport(0, 0, sui_screen_mode_size_x, sui_screen_mode_size_y);
			glMatrixMode(GL_MODELVIEW);	
			lines = sui_text_block_draw_sample(letter_size, letter_spacing, line_size, line_spacing, line_count, text);
		}
		glMatrixMode(GL_PROJECTION);
		glLoadIdentity();
		glFrustum(-sui_screen_mode_view_fov * sui_screen_mode_view_near, sui_screen_mode_view_fov * sui_screen_mode_view_near, -sui_screen_mode_view_fov * aspect * sui_screen_mode_view_near, sui_screen_mode_view_fov * aspect * sui_screen_mode_view_near, sui_screen_mode_view_near, sui_screen_mode_view_far);
	...
	return sui_text_block_draw_sample(letter_size, letter_spacing, line_size, line_spacing, line_count, text);
}
