...
extern void sui_manipulator_point_draw(float *pos, float red, float green, float blue);
...
extern char *sui_translate_internal(char *text, char *file, uint line);
extern void sui_translate_load(char *file);
extern void sui_translate_save(char *file);
extern char *sui_translate(char *text);
//#define sui_translate(n) sui_translate_internal(n, __FILE__, __LINE__)
