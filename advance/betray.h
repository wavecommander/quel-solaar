...
#define B_BUTTON_FORWARD 275
#define B_BUTTON_BACK 276
#define B_BUTTON_INSERT 277
#define B_BUTTON_DELETE 127
#define B_BUTTON_HOME 278
#define B_BUTTON_END 279
#define B_BUTTON_BACKSPACE 8
#define B_BUTTON_ENTER 13
#define B_BUTTON_F1 282
#define B_BUTTON_ESCAPE 27
#define B_BUTTON_SPACE 27
#define B_BUTTON_TAB 9
...
extern void		betray_framebuffer_save_settings(uint offset_x, uint offset_y, uint size_x, uint size_y, uint frame_count, uint frame_rate);
extern boolean  betray_capture;
...
//#define BETRAY_SDL_AUDIO_WRAPPER
//#define BETRAY_OPENAL_AUDIO_WRAPPER
//#define BETRAY_WIN32_AUDIO_WRAPPER

#ifdef BETRAY_SDL_AUDIO_WRAPPER
...
extern uint betray_audio_sound_create(uint type, uint length, uint frequency, void *data);
extern void betray_audio_sound_destroy(uint sound);

extern uint betray_audio_sound_play(uint sound, float *pos, float *vector, float speed, float volume, boolean loop, boolean ambient);
extern void betray_audio_sound_set(uint play, float *pos, float *vector, float speed, float volume, boolean loop, boolean ambient);
extern void betray_audio_sound_stop(uint play);

extern void betray_audio_listener(float *pos, float *vector, float *forward, float *side, float scale);
extern void betray_audio_master_volume_set(float volume);
extern float betray_audio_master_volume_get();
extern void betray_audio_master_volume_silence_cutoff(float volume);
extern void betray_audio_init();
