...
{
	seed *= 10; 
	c->head_size = size * 0.030156 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->neck_length = size * 0.020156 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->neck_pos = -0.2 + 0.8 * (get_rand(seed++) * alien * 2);
	c->torso_size = size * 0.064922 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->torso_width = size * 0.044453 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->stomach_size = size * 0.054219 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->butt_size = size * 0.0350453 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->butt_width = size * 0.03 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->body_length = 0; /* not used for humans */
	c->arms_size = size * 0.152344 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
	c->legs_size = size * 0.182344 * (get_rand(seed++) * alien * 2 + 1.0 - alien);
