...
extern void		sui_text_line_draw(float size, float spacing, const char *text, uint length, uint samples);
extern float	sui_text_line_length(float size, float spacing, const char *text, uint end);
extern uint		sui_text_line_hit_test(float letter_size, float letter_spacing, const char *text, float pos_x);
...
extern void		sui_text_block_draw(float letter_size, float letter_spacing, float line_size, float line_spacing, uint line_count, const char *text);
extern uint		sui_text_block_line_end(const char *text, float spacing, float letter_size, float size);
extern uint		sui_text_block_hit_test(float letter_size, float letter_spacing, float line_size, float line_spacing, uint line_count, const char *text, float pos_x, float pos_y);
